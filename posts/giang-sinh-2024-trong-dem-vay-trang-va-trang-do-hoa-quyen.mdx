...
export const metadata = {
  ...
  author: "NaviRanobe",
  thumbnail: "047-thumb.jpg",
  publishDate: "2024-12-11",
  description:
    "Nhân vật chính của câu chuyện là một nữ kiếm sĩ lừng danh tên Rin trước kia từng đồng hành cùng vị anh hùng. Cô được mời tới vùng lãnh thổ của ma tộc để tham gia vào biệt đội tinh nhuệ chuyên giải quyết mâu thuẫn giữa hai chủng tộc...",
  category: "12 Ngày Giáng Sinh",
};

export const detail = {
  jp: "白いドレスと紅い月がとけあう夜に",
  vn: "Tạm dịch: Trong đêm váy trắng và trăng đỏ hòa quyện",
  romaji: "Shiroi Dress to Akai Tsuki ga Tokeau Yoru ni",
  publisher: "Sneaker Bunko",
  author: "Mikazuki Hijiri",
  illustrator: "Komizuki",
  release: "01/12/2024",
  category: "Uiry, Trinh Thám",
  volume: "1 (Đã hoàn thành?)",
  en_trans: "Anh",
  en_trans_url:
    "https://kitsunetranslation.fantls.com/series/on-the-night-when-the-white-dress-and-the-red-moon-melt-together/",
  vi_trans: "Việt (Chưa có)",
  vi_trans_url: "",
  safety: "Hai con gei chỉ mới kết hôn, chưa ăn nhau",
};
