    ...
    <div className="h-screen w-full select-none pointer-events-none fixed overflow-hidden z-[5000]">
      <div className="fixed h-full w-full flex flex-col justify-center items-start translate-x-[-50vw] lg:translate-x-[-35vw] xl:translate-x-[-20vw] z-[6000]">
        ...
        <motion.div
          ...
          transition={{ duration: 3, delay: 4.5, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_01.png"
        ...
        <motion.div
          ...
          transition={{ duration: 3, delay: 5.6, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_01.png"
        ...
        <motion.div
          ...
          transition={{ duration: 3, delay: 5, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_02.png"
        ...
        <motion.div
          ...
          transition={{ duration: 3, delay: 5.2, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_02.png"
        ...
        <motion.div
          initial={{ x: 0, y: 0, rotate: 0 }}
          animate={{ x: "150vw", y: "-200px", rotate: 180 }}
          transition={{ duration: 3, delay: 4.6, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_02.png"
        ...
        <motion.div
          initial={{ x: 0, y: 0, rotate: 0 }}
          animate={{ x: "150vw", y: "-200px", rotate: 180 }}
          transition={{ duration: 3, delay: 5.8, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_02.png"
        ...
        <motion.div
          ...
          animate={{ x: "150vw", y: "-200px", rotate: 180 }}
          transition={{ duration: 3, delay: 4.8, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_03.png"
        ...
        <motion.div
          initial={{ x: 0, y: 0, rotate: 0 }}
          animate={{ x: "150vw", y: "-200px", rotate: 180 }}
          transition={{ duration: 3, delay: 5.5, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_03.png"
        ...
        <motion.div
          initial={{ x: 0, y: "100px", rotate: 0 }}
          animate={{ x: "150vw", y: "0", rotate: 180 }}
          transition={{ duration: 3, delay: 6, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_03.png"
        ...
        <motion.div
          initial={{ x: 0, y: "400px", rotate: 0 }}
          animate={{ x: "150vw", y: "100px", rotate: 180 }}
          transition={{ duration: 3, delay: 4.7, ease: "easeIn" }}
          className="fixed"
        >
          <Image
            src="/hana_04.png"
