...
export default function SplashScreen() {
  ...
  return shouldUnmount ? null : (
    <div className="h-screen w-full select-none pointer-events-none fixed inset-0 overflow-hidden z-5000">
      <div className="fixed inset-0 h-full w-full flex flex-col justify-center items-start translate-x-[-50vw] lg:translate-x-[-35vw] xl:translate-x-[-20vw] z-6000">
        {/* Hana 01 */}
        <motion.div
      ...
      <motion.div
        ...
        className="font-playfair fixed inset-0 flex flex-col justify-center items-center h-screen w-screen lg:text-xl xl:text-3xl gap-2 xl:gap-4 text-center px-4 text-slate-800 z-5001"
      >
        <motion.p
