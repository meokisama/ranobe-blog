    ...
    <div className="flex w-full flex-row justify-center items-center relative">
      <div className="flex flex-col w-full overflow-hidden pt-8 relative">
        <Image
          ...
          width={1308}
          height={1000}
          className="absolute w-full h-full -z-10 opacity-70 dark:invert dark:hidden"
        />
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <Image
            ...
            width={600}
            height={600}
            className="h-auto w-[55vw] lg:w-[30vw]"
          />
        </div>
        <div className="absolute mt-[20vw] -z-10 font-jaro font-normal w-full text-center overflow-hidden">
