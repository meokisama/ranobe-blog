  ...
  return (
    <div className="border border-orange-300 dark:border-none dark:text-foreground shadow-xl shadow-orange-300/30 dark:shadow-[rgba(0,0,0,0.3)] dark:shadow-[0_0_10px] relative max-w-6xl rounded-3xl overflow-hidden mx-auto flex flex-col md:flex-row items-center gap-4 backdrop-blur-sm mt-32">
      <div className="absolute inset-0">
        <div className="absolute inset-0 -z-1 h-full w-full dark:bg-accent bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-size-[14px_24px] [&>div]:absolute [&>div]:left-0 [&>div]:right-0 [&>div]:top-0 [&>div]:-z-10 [&>div]:m-auto [&>div]:h-77.5 [&>div]:w-77.5 [&>div]:rounded-full [&>div]:bg-fuchsia-400 [&>div]:opacity-20 [&>div]:blur-[100px]"></div>
      </div>
