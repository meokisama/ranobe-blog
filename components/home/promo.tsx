...
export const Promo = () => {
  return (
    <div className="border dark:border-none dark:text-[var(--foreground)] shadow-xs dark:shadow-[0_0_10px_rgba(0,0,0,0.3)] relative max-w-6xl rounded-3xl overflow-hidden mx-auto flex flex-col md:flex-row items-center gap-4 backdrop-blur-sm mt-32">
