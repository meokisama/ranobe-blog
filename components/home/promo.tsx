    ...
    <div className="border border-orange-300 dark:border-none dark:text-[var(--foreground)] shadow-xl shadow-orange-300/30 dark:shadow-[rgba(0,0,0,0.3)] dark:shadow-[0_0_10px] relative max-w-6xl rounded-3xl overflow-hidden mx-auto flex flex-col md:flex-row items-center gap-4 backdrop-blur-sm mt-32">
      ...
      <div className="flex-none p-4 text-center md:pl-12 md:text-left z-10 relative">
        <h2 className="text-2xl lg:text-3xl font-extrabold">
          Thích đọc truyện gốc tiếng Nhật?
        </h2>
        <p className="text-gray-500 font-medium dark:text-[var(--foreground)] text-lg lg:text-xl mt-2">
        ...
        <div className="flex gap-2 z-10 mt-8 justify-center md:justify-start">
          <Link href="https://lightnovel.vn" target="_blank">
            ...
            >
              <HomeIcon className="w-4 h-4 mt-[2px] mr-2" />
              Trình Đọc Raw
            </Button>
          </Link>
          <Link href="https://facebook.com/TheMeoki" target="_blank">
            <Button
              size="lg"
              variant="outline"
              className="cursor-pointer px-4 lg:text-lg"
            >
              <MessageCircleIcon className="w-4 h-4 mt-[2px] mr-2" />
              Nhắn Tin
            </Button>
          </Link>
        </div>
