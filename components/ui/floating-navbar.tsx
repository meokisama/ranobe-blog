  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed top-6 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-full dark:bg-[#212121] bg-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.08),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] px-2 sm:px-8 py-2  items-center justify-center gap-1 sm:space-x-4",
          className
        )}
      >
